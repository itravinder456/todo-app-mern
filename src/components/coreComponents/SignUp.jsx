              ...
              <div className="card-body">
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <label className="small mb-1" htmlFor="inputEmailAddress">User name</label>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <input className="form-control py-4" 
                         id="inputConfirmPassword" onChange={e=>handleChange(e,"firstName")}
                           className={`form-control py-4 ${
                          errors.password ? "invalid-field" : ""
                        }`}
                  ...
                  <div className="form-row">
                     ...
                     <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <label className="small mb-1" htmlFor="inputConfirmPassword">Phone</label>
                        <input className="form-control py-4" 
                        maxLength={10}
