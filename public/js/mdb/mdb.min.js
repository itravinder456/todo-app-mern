...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    return function(e, t, n, i) {
        ...
        function l(e, n, i, o) {
            ...
            function f(t) {
                for (var n = 0, o = 1, r = b - 1; o != r && C[o] <= t; ++o) n += w;
                var a = n + (t - C[--o]) / (C[o + 1] - C[o]) * w,
                    s = c(a, e, i);
                return s >= v ? u(t, a) : 0 == s ? a : p(t, n, n + w)
            }
        ...
        function c(e, t) {
            var n = e;
            return m.isString(e) ? b.Easings[e] || (n = !1) : n = m.isArray(e) && 1 === e.length ? s.apply(null, e) : m.isArray(e) && 2 === e.length ? w.apply(null, e.concat([t])) : !(!m.isArray(e) || 4 !== e.length) && l.apply(null, e), !1 === n && (n = b.Easings[b.defaults.easing] ? b.defaults.easing : y), n
        }
                        ...
                        for (var g = Math.min((t - f) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                            ...
                            if (a(S)) {
                                ...
                                for (var k in T)
                                    if ("element" !== k) {
                                        var _, P = T[k],
                                            O = m.isString(P.easing) ? b.Easings[P.easing] : P.easing;
                                        if (1 === g) _ = P.endValue;
                                        else {
                                            var A = P.endValue - P.startValue;
                                            if (_ = P.startValue + A * O(g, c, A), !h && _ === P.currentValue) continue
                                        }
                                        if (P.currentValue = _, "tween" === k) v = _;
                                        else {
                                            if (x.Hooks.registered[k]) {
                                                var W = x.Hooks.getRoot(k),
                                                    L = a(S).rootPropertyValueCache[W];
                                                L && (P.rootPropertyValue = L)
                                            }
                                            var M = x.setPropertyValue(S, k, P.currentValue + (0 === parseFloat(_) ? "" : P.unitType), P.rootPropertyValue, P.scrollData);
                                            x.Hooks.registered[k] && (a(S).rootPropertyValueCache[W] = x.Normalizations.registered[W] ? x.Normalizations.registered[W]("extract", null, M[1]) : M[1]), "transform" === M[0] && (E = !0)
                                        }
                                    }
                                c.mobileHA && a(S).transformCache.translate3d === i && (a(S).transformCache.translate3d = "(0px, 0px, 0px)", E = !0), E && x.flushTransformCache(S)
                            }
                        }
                        c.display !== i && "none" !== c.display && (b.State.calls[r][2].display = !1), c.visibility !== i && "hidden" !== c.visibility && (b.State.calls[r][2].visibility = !1), c.progress && c.progress.call(s[1], s[1], g, Math.max(0, f + c.duration - t), f, v), 1 === g && d(r)
                    }
            }
        ...
        function d(e, t) {
            ...
            for (var n = b.State.calls[e][0], o = b.State.calls[e][1], r = b.State.calls[e][2], s = b.State.calls[e][4], l = !1, c = 0, u = n.length; u > c; c++) {
                var d = n[c].element;
                if (t || r.loop || ("none" === r.display && x.setPropertyValue(d, "display", r.display), "hidden" === r.visibility && x.setPropertyValue(d, "visibility", r.visibility)), !0 !== r.loop && (p.queue(d)[1] === i || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) && a(d)) {
            ...
            if (!(7 >= f)) {
                        ...
                        register: function() {
                            ...
                            if (f)
                                for (t in x.Hooks.templates) {
                                    ...
                                    "Color" === i[0] && (i.push(i.shift()), o.push(o.shift()), x.Hooks.templates[t] = [i.join(" "), o.join(" ")])
                                }
                            for (t in x.Hooks.templates) {
                                i = (n = x.Hooks.templates[t])[0].split(" ");
                                for (var r in i) {
                    ...
                    getPropertyValue: function(e, n, o, r) {
                        function s(e, n) {
                            ...
                            if (8 >= f) l = p.css(e, n);
                                ...
                                var h;
                                h = a(e) === i ? t.getComputedStyle(e, null) : a(e).computedStyle ? a(e).computedStyle : a(e).computedStyle = t.getComputedStyle(e, null), "borderColor" === n && (n = "borderTopColor"), ("" === (l = 9 === f && "filter" === n ? h.getPropertyValue(n) : h[n]) || null === l) && (l = e.style[n]), o()
                            }
                        ...
                        if (x.Hooks.registered[n]) {
                            var c = n,
                                u = x.Hooks.getRoot(c);
                            o === i && (o = x.getPropertyValue(e, x.Names.prefixCheck(u)[0])), x.Normalizations.registered[u] && (o = x.Normalizations.registered[u]("extract", e, o)), l = x.Hooks.extractValue(c, o)
                    ...
                    setPropertyValue: function(e, n, i, o, r) {
                        ...
                        if ("scroll" === n) r.container ? r.container["scroll" + r.direction] = i : "Left" === r.direction ? t.scrollTo(i, r.alternateValue) : t.scrollTo(r.alternateValue, i);
                            ...
                            if (x.Hooks.registered[n]) {
                                var l = n,
                                    c = x.Hooks.getRoot(n);
                                o = o || x.getPropertyValue(e, c), i = x.Hooks.injectValue(l, i, o), n = c
                            }
                ...
                var T = function() {
                    ...
                    function o() {
                        function e(e) {
                            function d(e, t) {
                                var n = i,
                                    o = i,
                                    a = i;
                                return m.isArray(e) ? (n = e[0], !m.isArray(e[1]) && /^[\d-]/.test(e[1]) || m.isFunction(e[1]) || x.RegEx.isHex.test(e[1]) ? a = e[1] : (m.isString(e[1]) && !x.RegEx.isHex.test(e[1]) || m.isArray(e[1])) && (o = t ? e[1] : c(e[1], s.duration), e[2] !== i && (a = e[2]))) : n = e, t || (o = o || s.easing), m.isFunction(n) && (n = n.call(r, S, C)), m.isFunction(a) && (a = a.call(r, S, C)), [n || 0, o, a]
                            }
                            ...
                            if ("scroll" === k) {
                                var g, w, T, E = /^x$/i.test(s.axis) ? "Left" : "Top",
                                    _ = parseFloat(s.offset) || 0;
                                s.container ? m.isWrapped(s.container) || m.isNode(s.container) ? (s.container = s.container[0] || s.container, g = s.container["scroll" + E], T = g + p(r).position()[E.toLowerCase()] + _) : s.container = null : (g = b.State.scrollAnchor[b.State["scrollProperty" + E]], w = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === E ? "Top" : "Left")]], T = p(r).offset()[E.toLowerCase()] + _), l = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: g,
                                        currentValue: g,
                                ...
                                A = p.extend(!0, {}, a(r).tweensContainer);
                                for (var P in A)
                                    if ("element" !== P) {
                                        var O = A[P].startValue;
                                        A[P].startValue = A[P].currentValue = A[P].endValue, A[P].endValue = O, m.isEmptyObject(y) || (A[P].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + P + "): " + JSON.stringify(A[P]), r)
                                    }
                                l = A
                            } else if ("start" === k) {
                                var A;
                                a(r).tweensContainer && !0 === a(r).isAnimating && (A = a(r).tweensContainer), p.each(v, function(e, t) {
                                    if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(e)) {
                                        ...
                                        if (x.RegEx.isHex.test(o)) {
                                            for (var s = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(o), c = a ? x.Values.hexToRgb(a) : i, u = 0; u < s.length; u++) {
                                                var p = [l[u]];
                                                r && p.push(r), c !== i && p.push(c[u]), v[e + s[u]] = p
                                            }
                                            delete v[e]
                                        }
                                    }
                                ...
                                for (var M in v) {
                                    ...
                                    var X = x.Hooks.getRoot(M),
                                        V = !1;
                                    if (a(r).isSVG || "tween" === X || !1 !== x.Names.prefixCheck(X)[1] || x.Normalizations.registered[X] !== i) {
                                        (s.display !== i && null !== s.display && "none" !== s.display || s.visibility !== i && "hidden" !== s.visibility) && /opacity|filter/.test(M) && !Y && 0 !== R && (Y = 0), s._cacheValues && A && A[M] ? (Y === i && (Y = A[M].endValue + A[M].unitType), V = a(r).rootPropertyValueCache[X]) : x.Hooks.registered[M] ? Y === i ? (V = x.getPropertyValue(r, X), Y = x.getPropertyValue(r, M, V)) : V = x.Hooks.templates[X][1] : Y === i && (Y = x.getPropertyValue(r, M));
                                        var N, H, z, B = !1;
                                        if (N = f(M, Y), Y = N[0], z = N[1], N = f(M, R), R = N[0].replace(/^([+-\/*])=/, function(e, t) {
                                                return B = t, ""
                                            }), H = N[1], Y = parseFloat(Y) || 0, R = parseFloat(R) || 0, "%" === H && (/^(fontSize|lineHeight)$/.test(M) ? (R /= 100, H = "em") : /^scale/.test(M) ? (R /= 100, H = "") : /(Red|Green|Blue)$/i.test(M) && (R = R / 100 * 255, H = "")), /[\/*]/.test(B)) H = z;
                                        else if (z !== H && 0 !== Y)
                                            if (0 === R) H = z;
                                            else {
                                                o = o || function() {
                                                    var e = {
                                                        ...
                                                        i = e.position === W.lastPosition && e.myParent === W.lastParent,
                                                        o = e.fontSize === W.lastFontSize;
                                                    W.lastParent = e.myParent, W.lastPosition = e.position, W.lastFontSize = e.fontSize;
                                                    var s = 100,
                                                        l = {};
                                                    if (o && i) l.emToPx = W.lastEmToPx, l.percentToPxWidth = W.lastPercentToPxWidth, l.percentToPxHeight = W.lastPercentToPxHeight;
                                                    else {
                                                    ...
                                                    return null === W.remToPx && (W.remToPx = parseFloat(x.getPropertyValue(n.body, "fontSize")) || 16), null === W.vwToPx && (W.vwToPx = parseFloat(t.innerWidth) / 100, W.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = W.remToPx, l.vwToPx = W.vwToPx, l.vhToPx = W.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
                                                }();
                                                var j = /margin|padding|left|right|width|text|word|letter/i.test(M) || /X$/.test(M) || "x" === M ? "x" : "y";
                                                switch (z) {
                                                    case "%":
                                                        Y *= "x" === j ? o.percentToPxWidth : o.percentToPxHeight;
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                                ...
                                                switch (H) {
                                                    case "%":
                                                        Y *= 1 / ("x" === j ? o.percentToPxWidth : o.percentToPxHeight);
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                            ...
                            l.element && (x.Values.addClass(r, "velocity-animating"), L.push(l), "" === s.queue && (a(r).tweensContainer = l, a(r).opts = s), a(r).isAnimating = !0, S === C - 1 ? (b.State.calls.push([L, h, s, null, I.resolver]), !1 === b.State.isTicking && (b.State.isTicking = !0, u())) : S++)
                        }
                        var o, r = this,
                            s = p.extend({}, b.defaults, y),
                            l = {};
                        switch (a(r) === i && b.init(r), parseFloat(s.delay) && !1 !== s.queue && p.queue(r, s.queue, function(e) {
                        ...
                        }!1 !== b.mock && (!0 === b.mock ? s.duration = s.delay = 1 : (s.duration *= parseFloat(b.mock) || 1, s.delay *= parseFloat(b.mock) || 1)), s.easing = c(s.easing, s.duration), s.begin && !m.isFunction(s.begin) && (s.begin = null), s.progress && !m.isFunction(s.progress) && (s.progress = null), s.complete && !m.isFunction(s.complete) && (s.complete = null), s.display !== i && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = b.CSS.Values.getDisplayType(r))), s.visibility !== i && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread, !1 === s.queue ? s.delay ? setTimeout(e, s.delay) : e() : p.queue(r, s.queue, function(t, n) {
                            return !0 === n ? (I.promise && I.resolver(h), !0) : (b.velocityQueueEntryFlag = !0, void e(t))
                    ...
                    if (m.isWrapped(this) ? (s = !1, f = 0, h = this, l = this) : (s = !0, f = 1, h = w ? arguments[0].elements || arguments[0].e : arguments[0]), h = r(h)) {
                        ...
                        if (!/^(stop|finish)$/i.test(v) && !p.isPlainObject(y)) {
                            y = {};
                            for (var E = f + 1; E < arguments.length; E++) m.isArray(arguments[E]) || !/^(fast|normal|slow)$/i.test(arguments[E]) && !/^\d/.test(arguments[E]) ? m.isString(arguments[E]) || m.isArray(arguments[E]) ? y.easing = arguments[E] : m.isFunction(arguments[E]) && (y.complete = arguments[E]) : y.duration = arguments[E]
                        }
                        var I = {
                            promise: null,
                            resolver: null,
                            ...
                            case "stop":
                                ...
                                return p.each(b.State.calls, function(e, t) {
                                    t && p.each(t[1], function(n, o) {
                                        var r = y === i ? "" : y;
                                        return !0 !== r && t[2].queue !== r && (y !== i || !1 !== t[2].queue) || void p.each(h, function(n, i) {
                                            i === o && ((!0 === y || m.isString(y)) && (p.each(p.queue(i, m.isString(y) ? y : ""), function(e, t) {
                                                m.isFunction(t) && t(null, !0)
                                            }), p.queue(i, m.isString(y) ? y : "", [])), "stop" === v ? (a(i) && a(i).tweensContainer && !1 !== r && p.each(a(i).tweensContainer, function(e, t) {
                                                t.endValue = t.currentValue
                                            }), _.push(e)) : "finish" === v && (t[2].duration = 1))
                                        })
                                    })
                                }), "stop" === v && (p.each(_, function(e, t) {
                                    d(t, !0)
                                }), I.promise && I.resolver(h)), e();
                            default:
                                if (!p.isPlainObject(v) || m.isEmptyObject(v)) {
                                    if (m.isString(v) && b.Redirects[v]) {
                                        var P = (D = p.extend({}, y)).duration,
                                            O = D.delay || 0;
                                        return !0 === D.backwards && (h = p.extend(!0, [], h).reverse()), p.each(h, function(e, t) {
                                            parseFloat(D.stagger) ? D.delay = O + parseFloat(D.stagger) * e : m.isFunction(D.stagger) && (D.delay = O + D.stagger.call(t, e, C)), D.drag && (D.duration = parseFloat(P) || (/^(callout|transition)/.test(v) ? 1e3 : g), D.duration = Math.max(D.duration * (D.backwards ? 1 - e / C : (e + 1) / C), .75 * D.duration, 200)), b.Redirects[v].call(t, t, D || {}, e, C, h, I.promise ? I : i)
                                        }), e()
                                    }
                                    var A = "Velocity: First argument (" + v + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                    return I.promise ? I.rejecter(new Error(A)) : console.log(A), e()
                                }
                                k = "start"
                        }
                        var W = {
                        ...
                        if (D.loop = parseInt(D.loop), M = 2 * D.loop - 1, D.loop)
                            for (var R = 0; M > R; R++) {
                                ...
                                R === M - 1 && (F.display = D.display, F.visibility = D.visibility, F.complete = D.complete), T(h, "reverse", F)
                            }
                        return e()
                    }
                };
                (b = p.extend(T, b)).animate = T;
                ...
                }), e.Velocity = b, e !== t && (e.fn.velocity = T, e.fn.velocity.defaults = b.defaults), p.each(["Down", "Up"], function(e, t) {
    ...
    function(e, t) {
        ...
        return u.init = function(e) {
            ...
            if (t = t || {}, t.wait = t.wait || 0, t.position = t.position || null, n)
                for (var i, a, s, l = {}, c = 0, u = {
                    ...
                    if (i = e[c], a = t.position || {
                            x: i.clientWidth / 2,
                            y: i.clientHeight / 2
                        }, s = r(i), l.x = s.left + a.x, l.y = s.top + a.y, u.pageX = l.x, u.pageY = l.y, h.show(u, i), t.wait >= 0 && null !== t.wait) {
                        var d = {
                            type: "mouseup",
                            button: 1
                        };
            ...
            for (var t = {
                    type: "mouseup",
                    button: 1
                }, n = 0, i = (e = o(e)).length; n < i; n++) h.hide(t, e[n])
        ...
        e.fn.scrollTo = function(t) {
            ...
            this.each(function() {
                ...
                function o(t) {
                    ...
                    var m = 0,
                        v = a.parent();
                    if (!v.is("body") && v[0].scrollHeight > v[0].clientHeight && (m = v[0].scrollTop), r + c.innerWidth() > e(window).width() ? d = "right" : r - c.innerWidth() + a.innerWidth() < 0 && (d = "left"), u + c.innerHeight() > n)
...
dropdownSelectors.on({
    ...
    function(e, t, n, i) {
        ...
        function S(e) {
            ...
            return new(t || (Te ? Y : Ce ? N : xe ? z : F))(e, E)
        }
        ...
        function I(e, t) {
            var n = e.session,
                i = t.pointers,
                o = i.length;
            n.firstInput || (n.firstInput = P(t)), o > 1 && !n.firstMultiple ? n.firstMultiple = P(t) : 1 === o && (n.firstMultiple = !1);
            var r = n.firstInput,
                a = n.firstMultiple,
                s = a ? a.center : r.center,
                l = t.center = O(i);
            t.timeStamp = ve(), t.deltaTime = t.timeStamp - r.timeStamp, t.angle = M(s, l), t.distance = L(s, l), k(n, t), t.offsetDirection = W(t.deltaX, t.deltaY);
            var c = A(t.deltaTime, t.deltaX, t.deltaY);
            t.overallVelocityX = c.x, t.overallVelocityY = c.y, t.overallVelocity = me(c.x) > me(c.y) ? c.x : c.y, t.scale = a ? R(a.pointers, i) : 1, t.rotation = a ? D(a.pointers, i) : 0, t.maxPointers = n.prevInput ? t.pointers.length > n.prevInput.maxPointers ? t.pointers.length : n.prevInput.maxPointers : t.pointers.length, _(n, t);
            var u = e.element;
        ...
        function k(e, t) {
            var n = t.center,
                ...
                o = e.prevDelta || {},
                r = e.prevInput || {};
            t.eventType !== Ee && r.eventType !== ke || (o = e.prevDelta = {
                x: r.deltaX || 0,
                y: r.deltaY || 0
            }, i = e.offsetDelta = {
                x: n.x,
        ...
        function _(e, t) {
            ...
            if (t.eventType != _e && (l > Se || s.velocity === i)) {
                var c = t.deltaX - s.deltaX,
                    u = t.deltaY - s.deltaY,
                    d = A(l, c, u);
                o = d.x, r = d.y, n = me(d.x) > me(d.y) ? d.x : d.y, a = W(c, u), e.lastInterval = t
        ...
        function W(e, t) {
            return e === t ? Pe : me(e) >= me(t) ? e < 0 ? Oe : Ae : t < 0 ? We : Le
        }
        ...
        function D(e, t) {
            return M(t[1], t[0], Ye) + M(e[1], e[0], Ye)
        }

        function R(e, t) {
            return L(t[0], t[1], Ye) / L(e[0], e[1], Ye)
        }

        function F() {
            this.evEl = Ve, this.evWin = Ne, this.pressed = !1, C.apply(this, arguments)
        }

        function Y() {
            this.evEl = Be, this.evWin = je, C.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function X() {
            this.evTarget = $e, this.evWin = Ue, this.started = !1, C.apply(this, arguments)
        }

        function V(e, t) {
            var n = y(e.touches),
                i = y(e.changedTouches);
            return t & (ke | _e) && (n = b(n.concat(i), "identifier", !0)), [n, i]
        }
        ...
        function H(e, t) {
            ...
            for (o = 0; o < a.length;) i[a[o].identifier] && s.push(a[o]), t & (ke | _e) && delete i[a[o].identifier], o++;
        ...
        function z() {
            ...
            this.touch = new N(this.manager, e), this.mouse = new F(this.manager, e), this.primaryTouch = null, this.lastTouches = []
        }

        function B(e, t) {
            e & Ee ? (this.primaryTouch = t.changedPointers[0].identifier, j.call(this, t)) : e & (ke | _e) && j.call(this, t)
        }
        ...
        function K(e) {
            return e == Le ? "down" : e == We ? "up" : e == Oe ? "left" : e == Ae ? "right" : ""
        }
        ...
        function se(e, t) {
            this.options = ue({}, ae.defaults, t || {}), this.options.inputTarget = this.options.inputTarget || e, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = e, this.input = S(this), this.touchAction = new $(this, this.options.touchAction), le(this, !0), a(this.options.recognizers, function(e) {
        ...
        l(F, C, {
            handler: function(e) {
                var t = Xe[e.type];
                t & Ee && 0 === e.button && (this.pressed = !0), t & Ie && 1 !== e.which && (t = ke), this.pressed && (t & ke && (this.pressed = !1), this.callback(this.manager, t, {
                    pointers: [e],
                    changedPointers: [e],
                    pointerType: "mouse",
                    srcEvent: e
        ...
        e.MSPointerEvent && !e.PointerEvent && (Be = "MSPointerDown", je = "MSPointerMove MSPointerUp MSPointerCancel"), l(Y, C, {
            handler: function(e) {
                var t = this.store,
                    n = !1,
                ...
                o & Ee && (0 === e.button || a) ? s < 0 && (t.push(e), s = t.length - 1) : o & (ke | _e) && (n = !0), s < 0 || (t[s] = e, this.callback(this.manager, o, {
                    pointers: t,
                    changedPointers: [e],
                    pointerType: r,
                    srcEvent: e
        ...
        l(X, C, {
            handler: function(e) {
                ...
                if (t === Ee && (this.started = !0), this.started) {
                    ...
                    t & (ke | _e) && n[0].length - n[1].length == 0 && (this.started = !1), this.callback(this.manager, t, {
                        pointers: n[0],
                        changedPointers: n[1],
                        pointerType: "touch",
                        srcEvent: e
        ...
        $.prototype = {
            ...
            preventDefaults: function(e) {
                ...
                if (this.manager.session.prevented) t.preventDefault();
                    ...
                    if (!a || !r) return o || r && n & Me || a && n & De ? this.preventSrc(t) : void 0
                }
            },
        ...
        Z.prototype = {
            ...
            process: function(e) {
                var t = this.state,
                    ...
                    i = t & (lt | ct),
                    o = this.attrTest(e);
                return i && (n & _e || !o) ? t | pt : i || o ? n & ke ? t | ut : t & lt ? t | ct : lt : 32
            }
        }), l(ee, J, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function() {
                var e = this.options.direction,
                    t = [];
                return e & Me && t.push(rt), e & De && t.push(ot), t
            },
            directionTest: function(e) {
                var t = this.options,
                    ...
                    r = e.deltaX,
                    a = e.deltaY;
                return o & t.direction || (t.direction & Me ? (o = 0 === r ? Pe : r < 0 ? Oe : Ae, n = r != this.pX, i = Math.abs(e.deltaX)) : (o = 0 === a ? Pe : a < 0 ? We : Le, n = a != this.pY, i = Math.abs(e.deltaY))), e.direction = o, n && i > t.threshold && o & t.direction
            },
            attrTest: function(e) {
            ...
            process: function(e) {
                ...
                if (this._input = e, !i || !n || e.eventType & (ke | _e) && !r) this.reset();
            ...
            emit: function(e) {
                this.state === dt && (e && e.eventType & ke ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = ve(), this.manager.emit(this.options.event, this._input)))
            }
        }), l(ie, J, {
            defaults: {
                event: "rotate",
            ...
            attrTest: function(e) {
                ...
                return n & (Me | De) ? t = e.overallVelocity : n & Me ? t = e.overallVelocityX : n & De && (t = e.overallVelocityY), this._super.attrTest.call(this, e) && n & e.offsetDirection && e.distance > this.options.threshold && e.maxPointers == this.options.pointers && me(t) > this.options.velocity && e.eventType & ke
            },
            emit: function(e) {
...
function(e) {
            ...
            if (!i.hasClass("browser-default")) {
                ...
                if (l && (i.parent().find("span.caret").remove(), i.parent().find("input").remove(), i.unwrap(), e("ul#select-options-" + l).remove()), "destroy" !== t) {
                    ...
                    g && function() {
                        ...
                        d.append(n), n.find(".search").keyup(v)
                    }();
                        ...
                        e(this).click(function(l) {
                            if (!e(this).hasClass("disabled") && !e(this).hasClass("optgroup")) {
                                ...
                                r && a ? (e('input[type="checkbox"]', this).prop("checked", function(e, t) {
                                    ...
                                    return !t
                                }), c = n(f, e(this).index() - 1, i), x.trigger("focus")) : r ? (e('input[type="checkbox"]', this).prop("checked", function(e, t) {
                                    return !t
                                }), c = n(f, e(this).index(), i), x.trigger("focus")) : (d.find("li").removeClass("active"), e(this).toggleClass("active"), x.val(e(this).text())), T(d, e(this)), i.find("option").eq(o).prop("selected", c), i.trigger("change"), void 0 !== t && t()
                            }
                            l.stopPropagation()
                        })
                    }), i.wrap(u);
                    ...
                    var w = m.replace(/"/g, "&quot;"),
                        x = e('<input type="text" class="select-dropdown" readonly="true" ' + (i.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + c + '" value="' + w + '"/>');
                    i.before(x), x.before(b), x.after(d), i.is(":disabled") || x.dropdown({
                        hover: !1,
                        closeOnClick: !1
                    }), i.attr("tabindex") && e(x[0]).attr("tabindex", i.attr("tabindex")), i.addClass("initialized"), x.on({
                        focus: function() {
                        ...
                        if (9 != t.which)
                            if (40 != t.which || d.is(":visible")) {
                                if (13 != t.which || d.is(":visible")) {
                                    ...
                                    40 == t.which && (a = d.find("li.selected").length ? d.find("li.selected").next("li:not(.disabled)")[0] : d.find("li:not(.disabled)")[0], T(d, a)), 27 == t.which && x.trigger("close"), 38 == t.which && (a = d.find("li.selected").prev("li:not(.disabled)")[0]) && T(d, a), setTimeout(function() {
                                        C = []
                                    }, 1e3)
                                }
                            } else x.trigger("open");
    ...
    function(e, t) {
        ...
        return function(e, t, n, i) {
            ...
            o.extend(a, i);
            var s, l, c, u, d, p, f, h, m, v, g, y, b, w, x, T, C, S, E, I, k, _, P, O, A, W, L, M, D, R, F, Y, X, V, N, H, z, B, j, q, $, U, Z, Q, K, G, J, ee, te, ne, ie, oe, re, ae, se, le, ce = {
                    x: 0,
                    y: 0
                },
                ue = {
                ...
                _e = function(e, t, n, i, o) {
                    (!we || o && o !== r.currItem) && (i /= o ? o.fitRatio : r.currItem.fitRatio), e[_] = y + t + "px, " + n + "px" + b + " scale(" + i + ")"
                },
                Pe = function(e) {
                    te && (e && (v > r.currItem.fitRatio ? we || (an(r.currItem, !1, !0), we = !0) : we && (an(r.currItem), we = !1)), _e(te, de.x, de.y, v))
                },
                Oe = function(e) {
                ...
                Re = null,
                Fe = function() {
                    Re && (o.unbind(document, "mousemove", Fe), o.addClass(e, "pswp--has_mouse"), a.mouseUsed = !0, Ee("mouseUsed")), Re = setTimeout(function() {
                        Re = null
                    }, 100)
                },
                Ye = function() {
                    o.bind(document, "keydown", r), F.transform && o.bind(r.scrollWrap, "click", r), a.mouseUsed || o.bind(document, "mousemove", Fe), o.bind(window, "resize scroll", r), Ee("bindEvents")
                },
                Xe = function() {
                    o.unbind(window, "resize", r), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", Fe), F.transform && o.unbind(r.scrollWrap, "click", r), B && o.unbind(window, f, r), Ee("unbindEvents")
                },
                Ve = function(e, t) {
                    var n = tn(r.currItem, pe, e);
                    return t && (ee = n), n
                },
                Ne = function(e) {
                ...
                Be = function() {
                    ...
                    _ = "left", o.addClass(e, "pswp--ie"), Ae = function(e, t) {
                        t.left = e + "px"
                    }, Oe = function(e) {
                ...
                qe = function(e) {
                    e && ($ || q || ne || H) && (e.preventDefault(), e.stopPropagation())
                },
                $e = function() {
                ...
                Ze = 0,
                Qe = function(e) {
                    Ue[e] && (Ue[e].raf && W(Ue[e].raf), Ze--, delete Ue[e])
                },
                Ke = function(e) {
                ...
                Je = function(e, t, n, i, o, r, a) {
                    ...
                    var c = function() {
                        if (Ue[e]) {
                            if ((s = Ie() - l) >= i) return Qe(e), r(n), void(a && a());
                            r((n - t) * o(s / i) + t), Ue[e].raf = A(c)
                        }
                    };
                    c()
                },
                et = {
                    ...
                    setScrollOffset: function(e, t) {
                        he.x = e, R = he.y = t, Ee("updateScrollOffset", he)
                    },
                    ...
                    init: function() {
                        if (!s && !l) {
                            var n;
                            r.framework = o, r.template = e, r.bg = o.getChildByClass(e, "pswp__bg"), L = e.className, s = !0, F = o.detectFeatures(), A = F.raf, W = F.caf, _ = F.transform, D = F.oldIE, r.scrollWrap = o.getChildByClass(e, "pswp__scroll-wrap"), r.container = o.getChildByClass(r.scrollWrap, "pswp__container"), d = r.container.style, r.itemHolders = T = [{
                                ...
                                wrap: 0,
                                index: -1
                            }], T[0].el.style.display = T[2].el.style.display = "none", Be(), m = {
                                resize: r.updateSize,
                                scroll: $e,
                                keydown: je,
                                click: qe
                            ...
                            for (F.animationName && F.transform && !i || (a.showAnimationDuration = a.hideAnimationDuration = 0), n = 0; n < ye.length; n++) r["init" + ye[n]]();
                            t && (r.ui = new t(r, o)).init(), Ee("firstUpdate"), u = u || a.index || 0, (isNaN(u) || 0 > u || u >= Ut()) && (u = 0), r.currItem = $t(u), (F.isOldIOSPhone || F.isOldAndroid) && (ge = !1), e.setAttribute("aria-hidden", "false"), a.modal && (ge ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")), void 0 === R && (Ee("initialLayout"), R = M = o.getScrollY());
                            var c = "pswp--open ";
                            for (a.mainClass && (c += a.mainClass + " "), a.showHideOpacity && (c += "pswp--animate_opacity "), c += O ? "pswp--touch" : "pswp--notouch", c += F.animationName ? " pswp--css_animation" : "", c += F.svg ? " pswp--svg" : "", o.addClass(e, c), r.updateSize(), p = -1, ve = null, n = 0; 3 > n; n++) Ae((n + p) * me.x, T[n].el.style);
                            D || o.bind(r.scrollWrap, h, r), Se("initialZoomInEnd", function() {
                                r.setContent(T[0], u - 1), r.setContent(T[2], u + 1), T[0].el.style.display = T[2].el.style.display = "block", a.focus && e.focus(), Ye()
                            }), r.setContent(T[1], u), r.updateCurrItem(), Ee("afterInit"), ge || (w = setInterval(function() {
                                Ze || B || K || v !== r.currItem.initialZoomLevel || r.updateSize()
                            }, 1e3)), o.addClass(e, "pswp--visible")
                        }
                    },
                    close: function() {
                        s && (s = !1, l = !0, Ee("close"), Xe(), Qt(r.currItem, null, !0, r.destroy))
                    },
                    destroy: function() {
                        Ee("destroy"), zt && clearTimeout(zt), e.setAttribute("aria-hidden", "true"), e.className = L, w && clearInterval(w), o.unbind(r.scrollWrap, h, r), o.unbind(window, "scroll", r), bt(), Ge(), Ce = null
                    },
                    ...
                    goTo: function(e) {
                        var t = (e = Te(e)) - u;
                        ve = t, u = e, r.currItem = $t(u), fe -= t, We(me.x * fe), Ge(), ne = !1, r.updateCurrItem()
                    },
                    next: function() {
                        r.goTo(u + 1)
                    },
                    ...
                    updateCurrZoomItem: function(e) {
                        if (e && Ee("beforeChange", 0), T[1].el.children.length) {
                            var t = T[1].el.children[0];
                            te = o.hasClass(t, "pswp__zoom-wrap") ? t.style : null
                        } else te = null;
                        ee = r.currItem.bounds, g = v = r.currItem.initialZoomLevel, de.x = ee.center.x, de.y = ee.center.y, e && Ee("afterChange")
                    },
                    invalidateCurrItems: function() {
                        x = !0;
                        for (var e = 0; 3 > e; e++) T[e].item && (T[e].item.needsUpdate = !0)
                    },
                    updateCurrItem: function(e) {
                        if (0 !== ve) {
                            var t, n = Math.abs(ve);
                            if (!(e && 2 > n)) {
                                r.currItem = $t(u), we = !1, Ee("beforeChange", ve), n >= 3 && (p += ve + (ve > 0 ? -3 : 3), n = 3);
                                for (var i = 0; n > i; i++) ve > 0 ? (t = T.shift(), T[2] = t, p++, Ae((p + 2) * me.x, t.el.style), r.setContent(t, u - n + i + 1 + 1)) : (t = T.pop(), T.unshift(t), p--, Ae(p * me.x, t.el.style), r.setContent(t, u + n - i - 1 - 1));
                                if (te && 1 === Math.abs(ve)) {
                                    var o = $t(C);
                                    o.initialZoomLevel !== v && (tn(o, pe), an(o), Oe(o))
                                }
                                ve = 0, r.updateCurrZoomItem(), C = u, Ee("afterChange")
                            }
                        }
                    },
                    updateSize: function(t) {
                        ...
                        if (pe.x = r.scrollWrap.clientWidth, pe.y = r.scrollWrap.clientHeight, $e(), me.x = pe.x + Math.round(pe.x * a.spacing), me.y = pe.y, We(me.x * fe), Ee("beforeResize"), void 0 !== p) {
                            for (var i, s, l, c = 0; 3 > c; c++) i = T[c], Ae((c + p) * me.x, i.el.style), l = u + c - 1, a.loop && Ut() > 2 && (l = Te(l)), s = $t(l), s && (x || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s), r.setContent(i, l), 1 === c && (r.currItem = s, r.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && r.setContent(i, l), s && s.container && (tn(s, pe), an(s), Oe(s));
                            x = !1
                        }
                        g = v = r.currItem.initialZoomLevel, (ee = r.currItem.bounds) && (de.x = ee.center.x, de.y = ee.center.y, Pe(!0)), Ee("resize")
                    },
                    zoomTo: function(e, t, n, i, r) {
                        t && (g = v, ht.x = Math.abs(t.x) - de.x, ht.y = Math.abs(t.y) - de.y, Me(ue, de));
                        var a = Ve(e, !1),
                            s = {};
                ...
                Ct = {},
                St = function(e, t) {
                    return Ct.prevent = !Tt(e.target, a.isClickableElement), Ee("preventDragEvent", e, t, Ct), Ct.prevent
                },
                Et = function(e, t) {
                ...
                Wt = function(e) {
                    ...
                    })) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (At[0] = Et(e.touches[0], Pt), e.touches.length > 1 && (At[1] = Et(e.touches[1], Ot))) : (Pt.x = e.pageX, Pt.y = e.pageY, Pt.id = "", At[0] = Pt), At
                },
                Lt = function(e, t) {
                ...
                Mt = function(e) {
                    if (!("mousedown" === e.type && e.button > 0)) {
                        ...
                        if (!z || "mousedown" !== e.type) {
                            ...
                            var n = Wt(e),
                                i = n.length;
                            Q = null, Ge(), B && 1 !== i || (B = oe = !0, o.bind(window, f, r), N = se = re = H = Z = $ = j = q = !1, ie = null, Ee("firstTouchStart", n), Me(ue, de), ce.x = ce.y = 0, Me(ot, n[0]), Me(rt, ot), st.x = me.x * fe, lt = [{
                                x: ot.x,
                                y: ot.y
                            }], X = Y = Ie(), Ve(v, !0), bt(), wt()), !K && i > 1 && !ne && !Z && (g = v, q = !1, K = j = !0, ce.y = ce.x = 0, Me(ue, de), Me(tt, n[0]), Me(nt, n[1]), It(tt, nt, mt), ht.x = Math.abs(mt.x) - de.x, ht.y = Math.abs(mt.y) - de.y, G = J = yt(tt, nt))
                        }
                    }
                },
                Dt = function(e) {
                ...
                Rt = function() {
                    if (Q) {
                        var e = Q.length;
                        if (0 !== e)
                            if (Me(tt, Q[0]), it.x = tt.x - ot.x, it.y = tt.y - ot.y, K && e > 1) {
                                if (ot.x = tt.x, ot.y = tt.y, !it.x && !it.y && vt(Q[1], nt)) return;
                                Me(nt, Q[1]), q || (q = !0, Ee("zoomGestureStarted"));
                                var t = yt(tt, nt),
                                    n = Nt(t);
                                ...
                                0 > i && (i = 0), G = t, It(tt, nt, dt), ce.x += dt.x - mt.x, ce.y += dt.y - mt.y, Me(mt, dt), de.x = Le("x", n), de.y = Le("y", n), N = n > v, v = n, Pe()
                            } else {
                                if (!ie) return;
                                if (oe && (oe = !1, Math.abs(it.x) >= 10 && (it.x -= Q[0].x - rt.x), Math.abs(it.y) >= 10 && (it.y -= Q[0].y - rt.y)), ot.x = tt.x, ot.y = tt.y, 0 === it.x && 0 === it.y) return;
                                if ("v" === ie && a.closeOnVerticalDrag && !xt()) {
                                    ce.y += it.y, de.y += it.y;
                                    var c = _t();
                                    return H = !0, Ee("onVerticalDrag", c), ke(c), void Pe()
                                }
                                kt(Ie(), tt.x, tt.y), $ = !0, ee = r.currItem.bounds, Lt("x", it) || (Lt("y", it), De(de), Pe())
                            }
                    }
                },
                Ft = function(e) {
                    ...
                    1 === c && Me(rt, l[0]), 0 !== c || ie || ne || (t || ("mouseup" === e.type ? t = {
                        x: e.pageX,
                        y: e.pageY,
                        type: "mouse"
                    ...
                    var u = -1;
                    if (0 === c && (B = !1, o.unbind(window, f, r), bt(), K ? u = 0 : -1 !== pt && (u = Ie() - pt)), pt = 1 === c ? Ie() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", K && 2 > c && (K = !1, 1 === c && (s = "zoomPointerUp"), Ee("zoomGestureEnded")), Q = null, $ || q || ne || H)
                        if (Ge(), V || (V = Yt()), V.calculateSwipeSpeed("x"), H)
                            if (_t() < a.verticalDragRange) r.close();
                            else {
                                var d = de.y,
                                    p = ae;
                                Je("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(e) {
                                    de.y = (r.currItem.initialPosition.y - d) * e + d, ke((1 - p) * e + p), Pe()
                                }), Ee("onVerticalDrag", 1)
                            }
                    else {
                        if ((Z || ne) && 0 === c) {
                        ...
                        if (!ne) return "swipe" !== s ? void Ht() : void(!Z && v > r.currItem.fitRatio && Xt(V))
                    }
                },
                Yt = function() {
                    var e, t, n = {
                        ...
                        calculateSwipeSpeed: function(i) {
                            lt.length > 1 ? (e = Ie() - X + 50, t = lt[lt.length - 2][i]) : (e = Ie() - Y, t = rt[i]), n.lastFlickOffset[i] = ot[i] - t, n.lastFlickDist[i] = Math.abs(n.lastFlickOffset[i]), n.lastFlickDist[i] > 20 ? n.lastFlickSpeed[i] = n.lastFlickOffset[i] / e : n.lastFlickSpeed[i] = 0, Math.abs(n.lastFlickSpeed[i]) < .1 && (n.lastFlickSpeed[i] = 0), n.slowDownRatio[i] = .95, n.slowDownRatioReverse[i] = 1 - n.slowDownRatio[i], n.speedDecelerationRatio[i] = 1
                        },
                        ...
                        panAnimLoop: function() {
                            return Ue.zoomPan && (Ue.zoomPan.raf = A(n.panAnimLoop), n.now = Ie(), n.timeDiff = n.now - n.lastNow, n.lastNow = n.now, n.calculateAnimOffset("x"), n.calculateAnimOffset("y"), Pe(), n.calculateOverBoundsAnimOffset("x"), n.calculateOverBoundsAnimOffset("y"), n.speedDecelerationRatioAbs.x < .05 && n.speedDecelerationRatioAbs.y < .05) ? (de.x = Math.round(de.x), de.y = Math.round(de.y), Pe(), void Qe("zoomPan")) : void 0
                        }
                    };
                    return n
                },
                ...
                Vt = function(e, t) {
                    ...
                    var c;
                    i && (u += i, 0 > u ? (u = a.loop ? Ut() - 1 : 0, c = !0) : u >= Ut() && (u = a.loop ? 0 : Ut() - 1, c = !0), (!c || a.loop) && (ve += i, fe -= i, n = !0));
                    var d, p = me.x * fe,
                        f = Math.abs(p - ft.x);
                    return n || p > ft.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? f / Math.abs(t.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, ut === u && (n = !1), ne = !0, Ee("mainScrollAnimStart"), Je("mainScroll", ft.x, p, d, o.easing.cubic.out, We, function() {
                        Ge(), ne = !1, ut = -1, (n || ut !== u) && r.updateCurrItem(), Ee("mainScrollAnimComplete")
                ...
                Ht = function() {
                    ...
                    t > v ? e = t : v > n && (e = n);
                    var i, a = ae;
                    return re && !N && !se && t > v ? (r.close(), !0) : (re && (i = function(e) {
                        ke((1 - a) * e + a)
                ...
                publicMethods: {
                    initGestures: function() {
                        var e = function(e, t, n, i, o) {
                            S = e + t, E = e + n, I = e + i, k = o ? e + o : ""
                        };
                        (P = F.pointerEvent) && F.touch && (F.touch = !1), P ? navigator.pointerEnabled ? e("pointer", "down", "move", "up", "cancel") : e("MSPointer", "Down", "Move", "Up", "Cancel") : F.touch ? (e("touch", "start", "move", "end", "cancel"), O = !0) : e("mouse", "down", "move", "up"), f = E + " " + I + " " + k, h = S, P && !O && (O = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), r.likelyTouchDevice = O, m[S] = Mt, m[E] = Dt, m[I] = Ft, k && (m[k] = m[I]), F.touch && (h += " mousedown", f += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[E], m.mouseup = m[I]), O || (a.allowPanToNext = !1)
                    }
                }
            });
            var zt, Bt, jt, qt, $t, Ut, Zt, Qt = function(t, n, i, s) {
                    zt && clearTimeout(zt), qt = !0, jt = !0;
                    var l;
                    ...
                    var d = i ? a.hideAnimationDuration : a.showAnimationDuration,
                        p = function() {
                            Qe("initialZoom"), i ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (ke(1), n && (n.style.display = "block"), o.addClass(e, "pswp--animated-in"), Ee("initialZoom" + (i ? "OutEnd" : "InEnd"))), s && s(), qt = !1
                        };
                    if (!d || !l || void 0 === l.x) return Ee("initialZoom" + (i ? "Out" : "In")), v = t.initialZoomLevel, Me(de, t.initialPosition), Pe(), e.style.opacity = i ? 0 : 1, ke(1), void(d ? setTimeout(function() {
                        p()
                    }, d) : p());
                    ! function() {
                        var n = c,
                            s = !r.currItem.src || r.currItem.loadError || a.showHideOpacity;
                        t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (v = l.w / t.w, de.x = l.x, de.y = l.y - M, r[s ? "template" : "bg"].style.opacity = .001, Pe()), Ke("initialZoom"), i && !n && o.removeClass(e, "pswp--animated-in"), s && (i ? o[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function() {
                            ...
                            if (Ee("initialZoom" + (i ? "Out" : "In")), i) {
                                var r = l.w / t.w,
                                    ...
                                    u = ae,
                                    f = function(t) {
                                        1 === t ? (v = r, de.x = l.x, de.y = l.y - R) : (v = (r - c) * t + c, de.x = (l.x - a.x) * t + a.x, de.y = (l.y - R - a.y) * t + a.y), Pe(), s ? e.style.opacity = 1 - t : ke(u - t * u)
                                    };
                                n ? Je("initialZoom", 0, 1, d, o.easing.cubic.out, f, p) : (f(1), zt = setTimeout(p, d + 20))
                            } else v = t.initialZoomLevel, Me(de, t.initialPosition), Pe(), ke(1), s ? e.style.opacity = 1 : ke(1), zt = setTimeout(p, d + 20)
                        }, i ? 25 : 90)
                    }()
                },
                Kt = {},
                ...
                tn = function(e, t, n) {
                    if (e.src && !e.loadError) {
                        ...
                        if (i && (e.vGap || (e.vGap = {
                                top: 0,
                                bottom: 0
                            }), Ee("parseVerticalMargin", e)), Kt.x = t.x, Kt.y = t.y - e.vGap.top - e.vGap.bottom, i) {
                            var o = Kt.x / e.w,
                                r = Kt.y / e.h;
                            e.fitRatio = r > o ? o : r;
                            var s = a.scaleMode;
                ...
                nn = function(e, t, n, i, o, a) {
                    t.loadError || i && (t.imageAppended = !0, an(t, i, t === r.currItem && we), n.appendChild(i), a && setTimeout(function() {
                ...
                sn = function() {
                    if (Gt.length) {
                        for (var e, t = 0; t < Gt.length; t++)(e = Gt[t]).holder.index === e.index && nn(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                        Gt = []
                    }
                };
            xe("Controller", {
                publicMethods: {
                    lazyLoadItem: function(e) {
                        e = Te(e);
                        var t = $t(e);
                        t && (!t.loaded && !t.loading || x) && (Ee("gettingData", e, t), t.src && on(t))
                    },
                    initController: function() {
                        o.extend(a, Jt, !0), r.items = Bt = n, $t = r.getItemAt, Ut = a.getNumItemsFn, Zt = a.loop, Ut() < 3 && (a.loop = !1), Se("beforeChange", function(e) {
                            var t, n = a.preload,
                                i = null === e || e >= 0,
                                o = Math.min(n[0], Ut()),
                                s = Math.min(n[1], Ut());
                        ...
                        }), Se("mainScrollAnimComplete", sn), Se("initialZoomInEnd", sn), Se("destroy", function() {
                    ...
                    setContent: function(e, t) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), rn(l), tn(l, pe), !l.src || l.loadError || l.loaded) l.src && !l.loadError && (i = o.createEl("pswp__img", "img"), i.style.opacity = 1, i.src = l.src, an(l, i), nn(0, l, c, i));
                            else {
                                if (l.loadComplete = function(n) {
                                        if (s) {
                                            if (e && e.index === t) {
                                                if (rn(n, !0)) return n.loadComplete = n.img = null, tn(n, pe), Oe(n), void(e.index === u && r.updateCurrZoomItem());
                                                n.imageAppended ? !qt && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : F.transform && (ne || qt) ? Gt.push({
                                                    item: n,
                                                    baseDiv: c,
                                                    img: n.img,
                                                    index: t,
                                    ...
                                    l.msrc && (p.src = l.msrc), an(l, p), c.appendChild(p), l.placeholder = p
                                }
                                l.loading || on(l), r.allowProgressiveImg() && (!jt && F.transform ? Gt.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: t,
                            ...
                            jt || t !== u ? Oe(l) : (te = c.style, Qt(l, i || l.img)), e.el.innerHTML = "", e.el.appendChild(c)
                        } else e.el.innerHTML = ""
                    },
            ...
            xe("Tap", {
                publicMethods: {
                    ...
                    onTapRelease: function(e, t) {
                        if (t && !$ && !j && !Ze) {
                            var n = t;
                            if (ln && (clearTimeout(ln), ln = null, gt(n, cn))) return void Ee("doubleTap", n);
                            ...
                            Me(cn, n), ln = setTimeout(function() {
                                un(e, t), ln = null
                            }, 300)
                        }
                    }
            ...
            xe("DesktopZoom", {
                publicMethods: {
                    ...
                    handleMouseWheel: function(e) {
                        if (v <= r.currItem.fitRatio) return a.modal && (!a.closeOnScroll || Ze || B ? e.preventDefault() : _ && Math.abs(e.deltaY) > 2 && (c = !0, r.close())), !0;
            ...
            var pn, fn, hn, mn, vn, gn, yn, bn, wn, xn, Tn, Cn, Sn = {
                    history: !0,
                    galleryUID: 1
                },
                En = function() {
                ...
                _n = function() {
                    if (hn && clearTimeout(hn), Ze || B) hn = setTimeout(_n, 500);
                    else {
                        ...
                        bn || -1 === Tn.hash.indexOf(n) && (xn = !0);
                        var i = Tn.href.split("#")[0] + "#" + n;
                        Cn ? "#" + n !== window.location.hash && history[bn ? "replaceState" : "pushState"]("", document.title, i) : bn ? Tn.replace(i) : Tn.hash = n, bn = !0, fn = setTimeout(function() {
                            mn = !1
                        }, 60)
                    }
                };
                ...
                publicMethods: {
                    initHistory: function() {
                        if (o.extend(a, Sn, !0), a.history) {
                            Tn = window.location, xn = !1, wn = !1, bn = !1, yn = En(), Cn = "pushState" in history, yn.indexOf("gid=") > -1 && (yn = yn.split("&gid=")[0], yn = yn.split("?gid=")[0]), Se("afterChange", r.updateURL), Se("unbindEvents", function() {
                                o.unbind(window, "hashchange", r.onHashChange)
                            });
                            var e = function() {
                                gn = !0, wn || (xn ? history.back() : yn ? Tn.hash = yn : Cn ? history.pushState("", document.title, Tn.pathname + Tn.search) : Tn.hash = ""), In()
                            };
                            Se("unbindEvents", function() {
                                c && e()
                            }), Se("destroy", function() {
                    ...
                    onHashChange: function() {
                        return En() === yn ? (wn = !0, void r.close()) : void(mn || (vn = !0, r.goTo(kn().pid), vn = !1))
                    },
                    updateURL: function() {
                        In(), vn || (bn ? pn = setTimeout(_n, 800) : _n())
                    }
                }
            }), o.extend(r, et)
        }
    ...
    function(e, t) {
        ...
        "use strict";
        return function(e, t) {
            var n, i, o, r, a, s, l, c, u, d, p, f, h, m, v, g, y, b, w, x = this,
                T = !1,
                C = !0,
                S = !0,
                E = {
                ...
                I = function(e) {
                    ...
                    for (var n, i, o = (e.target || e.srcElement).getAttribute("class") || "", r = 0; r < B.length; r++)(n = B[r]).onTap && o.indexOf("pswp__" + n.name) > -1 && (n.onTap(), i = !0);
                    if (i) {
                ...
                L = function() {
                    ...
                    l.children[0].innerHTML = r, l.children[0].onclick = W
                },
                M = function(e) {
                ...
                X = function() {
                    v.preloaderEl && (V(!0), d("beforeChange", function() {
                ...
                N = function(e) {
                    ...
                    if (k()) {
                        ...
                        if (v.captionEl && "auto" === a.bottom)
                            if (r || ((r = t.createEl("pswp__caption pswp__caption--fake")).appendChild(t.createEl("pswp__caption__center")), i.insertBefore(r, o), t.addClass(i, "pswp__ui--fit")), v.addCaptionHTMLFn(e, r, !0)) {
                ...
                H = function() {
                    v.timeToIdle && d("mouseUsed", function() {
                        t.bind(document, "mousemove", R), t.bind(document, "mouseout", F), b = setInterval(function() {
                            2 == ++D && x.setIdle(!0)
                        }, v.timeToIdle / 2)
                    })
                },
            ...
            x.init = function() {
                t.extend(e.options, E, !0), v = e.options, i = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, z(), d("beforeChange", x.update), d("doubleTap", function(t) {
                    ...
                    S || A(), b && clearInterval(b), t.unbind(document, "mouseout", F), t.unbind(document, "mousemove", R), t.unbind(i, "pswpTap click", I), t.unbind(e.scrollWrap, "pswpTap", x.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", x.onMouseOver), n && (t.unbind(document, n.eventK, x.updateFullscreen), n.isFullscreen() && (v.hideAnimationDuration = 0, n.exit()), n = null)
                }), d("destroy", function() {
                ...
                }), d("parseVerticalMargin", N), j(), v.shareEl && s && l && (S = !0), P(), H(), Y(), X()
            }, x.setIdle = function(e) {
                u = e, _(i, "ui--idle", e)
            }, x.update = function() {
                C && e.currItem ? (x.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(e.currItem, o), _(o, "caption--empty", !e.currItem.title)), T = !0) : T = !1, S || A(), P()
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
                ...
                t.event.bind(t.ownerDocument, "keydown", function(c) {
                    if (!(c.isDefaultPrevented && c.isDefaultPrevented() || c.defaultPrevented)) {
                        ...
                        if (i || u) {
                            ...
                            l(e, "top", e.scrollTop - f), l(e, "left", e.scrollLeft + p), s(e), (a = n(p, f)) && c.preventDefault()
                        }
                    }
                })
            }
    ...
    }, {}, [1]), $("body").on("shown.bs.modal", ".modal", function() {
